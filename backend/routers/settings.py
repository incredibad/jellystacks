...
SETTING_KEYS = ["jellyfin_url", "jellyfin_api_key", "jellyfin_user_id", "tmdb_api_key", "tmdb_related_enabled", "mdblist_api_key", "tvdb_api_key", "collection_refresh_interval"]
