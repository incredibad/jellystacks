...
export default function Collections() {
  ...
  const filtered = useMemo(() => {
    ...
    else if (filter === 'custom') result = collections.filter(c => !c.is_jellyfin_native && !c.tmdb_collection_id && !c.mdblist_list_id && !c.trakt_list_id)
    else if (filter === 'tmdb') result = collections.filter(c => !!c.tmdb_collection_id)
  ...
  const customCount = collections.filter(c => !c.is_jellyfin_native && !c.tmdb_collection_id && !c.mdblist_list_id && !c.trakt_list_id).length
  const tmdbCount = collections.filter(c => !!c.tmdb_collection_id).length
